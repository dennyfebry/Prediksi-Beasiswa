        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="alert-title dropzone-custom-sys">
                    <h2>Upload PPA Data Testing</h2>
                    <!-- <p>Dropzone Drag and Drop file uploads PPA Data Test.</p> -->
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="dropzone-pro mg-tb-30">
                    <div id="dropzone1" class="multi-uploader-cs">
                        <!-- <form action="upload/testing.php" class="dropzone dropzone-custom needsclick" id="demo1-upload"> -->
                        <form action="upload/testing.php" enctype="multipart/form-data" method="post">
                            <center>
                                <div class="dz-message needsclick download-custom">
                                    <i class="fa fa-download" aria-hidden="true"></i>
                                    <!-- <h2>Drop files here or click to upload.</h2> -->
                                    <p><span class="note needsclick">PPA Data Testing</span>
                                    </p>
                                </div>
                                <input class="btn btn-primary" name="filetesting" type="file" required="required"><br>
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Projects <span class="table-project-n">Data</span> Testing</h1>
                        </div>
                    </div>
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <?php
                            $sql = "SELECT * FROM testing WHERE tags=0 ";
